...
#		pragma message("GLM: GLM_GTX_matrix_interpolation is an experimental extension and may change in the future. Use  before including it, if you really want to use it.")
#	else
