...
class HelloArApplication {
 ...
 private:
  ...
  // This is the most recent frame created based on the output hardware buffer.
  // In each OnDrawFrame, the old one will be clean and the new one will
  // be created.
  EGLImageKHR egl_image_ = EGL_NO_IMAGE;
