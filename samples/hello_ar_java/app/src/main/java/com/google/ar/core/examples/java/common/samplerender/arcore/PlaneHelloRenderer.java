...
public class PlaneHelloRenderer {
  private static final String TAG = PlaneHelloRenderer.class.getSimpleName();
   ...
   */
  public PlaneHelloRenderer(SampleRender render) throws IOException {
    Texture texture =
