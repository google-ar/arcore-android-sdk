...
#ifndef C_ARCORE_CLOUD_ANCHOR_HELLO_AR_APPLICATION_H_
#define C_ARCORE_CLOUD_ANCHOR_HELLO_AR_APPLICATION_H_
...
class HelloArApplication {
 ...
 private:
  ...
  std::shared_ptr<CloudAnchorManager> cloud_anchor_manager_;
...
#endif  // C_ARCORE_CLOUD_ANCHOR_HELLO_AR_APPLICATION_H_
