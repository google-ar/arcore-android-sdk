...
/**
 * This is an example that shows how to create a Vulkan rendering application using the ARCore
 * C API.
 */
public class HelloArVulkanActivity extends AppCompatActivity
    implements VulkanSurfaceView.Renderer, DisplayManager.DisplayListener {
  private static final String TAG = HelloArVulkanActivity.class.getSimpleName();
        ...
        new GestureDetector(
            ...
            new GestureDetector.SimpleOnGestureListener() {
              ...
              public boolean onSingleTapUp(final MotionEvent e) {
                ...
                HelloArVulkanActivity.this.runOnUiThread(() -> showOcclusionDialogIfNeeded());
    ...
    settingsButton.setOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View v) {
            PopupMenu popup = new PopupMenu(HelloArVulkanActivity.this, v);
            popup.setOnMenuItemClickListener(HelloArVulkanActivity.this::settingsMenuClick);
  ...
  public void onSurfaceDestroyed() {
    JniInterface.onSurfaceDestroyed(nativeApplication);
  }
  ...
  public void onDrawFrame() {
    ...
    synchronized (this) {
      ...
      JniInterface.onSurfaceDrawFrame(
          nativeApplication,
  ...
  private void displayInSnackbar(String message) {
    snackbar =
        Snackbar.make(
            HelloArVulkanActivity.this.findViewById(android.R.id.content),
            message,
